...
import { recommendInternships, getAIGenerationStatus } from "@/actions/career";
    ...
    <div className="space-y-6">
      ...
      {internships.length === 0 ? (
        profileReady && !dataReady ? (
          <GeneratingBanner message="Your internship suggestions are being generated by AI. This usually takes 20–40 seconds." />
        ) : (
